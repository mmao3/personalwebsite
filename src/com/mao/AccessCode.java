...
/**
 * Servlet implementation class AccessCode
 */
@WebServlet("/AccessCode")
public class AccessCode extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// TODO Auto-generated method stub
		String sql="select * from accessCode where id = "+"'"+(String)jsonMap.get("id")+"'";
		Connection conn=null;
		try {
			conn = DataSource.getInstance().getConnection();
			System.out.println("get connected");
			System.out.println(conn);
			String json=OperateTable.getAccessCode(conn,sql);
